...
class Tasks extends Admin_Controller
{
    ...
    public function hide($id = 0)
    {
        ...
        $this->m_core->addNotification($submission['user_id'], 'You proof for task <b>' . $submission['name'] . '</b> was denied.', 2);
    ...
    public function accept($id)
    {
        ...
        $user = $this->m_core->get_user_from_id($submission['user_id']);
        ...
        $this->m_core->addNotification($submission['user_id'], format_money($submission['usd_reward']) . ' USD has been credited to your balance from task <b>' . $submission['name'] . '</b>', 1);
