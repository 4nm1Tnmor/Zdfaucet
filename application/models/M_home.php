...
class M_Home extends CI_Model
{
	...
	{
		return $this->db->query('SELECT users.username, withdraw_history.* FROM users, withdraw_history WHERE withdraw_history.user_id=users.id ORDER BY id DESC LIMIT 20')->result_array();
	}
