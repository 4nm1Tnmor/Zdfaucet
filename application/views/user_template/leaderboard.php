...
<div class="alert alert-warning text-center">Weekly Leaderboard Resets In <?= timespan(time(), $settings["leaderboard_date"], 2) ?> and updated every 10 minutes!</div>
<div class="row">
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                foreach ($topClaimer as $u) {
                                    ...
                                    echo '<tr><th scope="row">' . ++$rank . '</th><td class="username-rank">' . $u["username"] . '</td><td>' . $u["level"] . '</td><td>' . $u["claims"] . '</td><td>' . $reward . ' USD</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                foreach ($topReferral as $u) {
                                    $reward = $rank < count($rewards) ? $rewards[$rank] : 0;
                                    echo '<tr><th scope="row">' . ++$rank . '</th><td class="username-rank">' . $u["username"] . '</td><td>' . $u["level"] . '</td><td>' . $u["ref_count"] . '</td><td>' . $reward . ' USD</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                foreach ($topFaucet as $u) {
                                    $reward = $rank < count($rewards) ? $rewards[$rank] : 0;
                                    echo '<tr><th scope="row">' . ++$rank . '</th><td class="username-rank">' . $u["username"] . '</td><td>' . $u["level"] . '</td><td>' . $u["faucet_count_tmp"] . '</td><td>' . $reward . ' USD</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                foreach ($topShortlink as $u) {
                                    $reward = $rank < count($rewards) ? $rewards[$rank] : 0;
                                    echo '<tr><th scope="row">' . ++$rank . '</th><td class="username-rank">' . $u["username"] . '</td><td>' . $u["level"] . '</td><td>' . $u["shortlink_count_tmp"] . '</td><td>' . $reward . ' USD</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                ...
                                foreach ($topOfferwall as $u) {
                                    $reward = $rank < count($rewards) ? $rewards[$rank] : 0;
                                    echo '<tr><th scope="row">' . ++$rank . '</th><td class="username-rank">' . $u["username"] . '</td><td>' . $u["level"] . '</td><td>' . $u["offerwall_count_tmp"] . '</td><td>' . $reward . ' USD</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
