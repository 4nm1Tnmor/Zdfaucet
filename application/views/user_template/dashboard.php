            ...
            <div class="pt-4">
              <div class="row">
                <div class="col-6">
                  ...
                  <p class="text-muted mb-0"><?= format_money($user["total_earned"]) ?> USD</p>
                </div>
                <div class="col-6">
          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body">
                ...
                <h4 class="mb-0"><?= format_money($user['balance']) ?></h4>
              </div>
          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body">
                ...
                <h4 class="mb-0"><?= $user['dep_balance'] ?></h4>
              </div>
                ...
                <div class="col-xl-4 col-sm-6">
                  <div class="mb-3">
                    ...
                    <div>
                      ...
                      <h5 class="font-size-14">1 <?= $method['code'] ?> = <?= format_money($method['price']) ?> USD</h5>
                    </div>
                  </div>
                </div>
              <?php } ?>
              ...
              <div class="col-sm-6">
                <div class="input-group mb-2 currency-value">
                  <div class="input-group-prepend">
                    <span class="input-group-text">USD Balance</span>
                  </div>
                  <input type="number" name="amount" id="usdBalance" value="<?= format_money($user['balance']) ?>" class="form-control" min="0.000001" max="<?= $user['balance'] ?>" step="0.000001">
                </div>
              </div>
