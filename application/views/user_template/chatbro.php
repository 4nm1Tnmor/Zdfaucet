...
if (isset($user)) {
    ...
    // Configure here
    $admins = ['tungaqhd2', 'admin1', 'admin2'];
    $secretKey = '';
    $encodedChatId = '';
    $siteDomain = 'tung.com'; // without https or http and www
    // END
...
?>
        ...
        <script id="chatBroEmbedCode">
            ...
            ChatbroLoader({
                ...
                signature: '<?= md5($siteDomain . '' . $siteUserExternalId . '' . $siteUserFullName . '' . $siteUserAvatarUrl . '' . $siteUserProfileUrl . '' . $siteUserFullNameColor . '' . $secretKey) ?>'
            });
        </script>
<?php }
} ?>