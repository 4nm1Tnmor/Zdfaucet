                                    ...
                                    <div class="testimonial-quote-wrap">
                                        <div class="media author-info mb-3">
                                            ...
                                            <div class="media-body text-white">
                                                <h5 class="mb-0 text-white">Tung Nguyen</h5>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-7">
                    <div class="copyright-wrap small-text">
                        <p class="mb-0">&copy <?= date('Y') ?> <a href="<?= base_url() ?>"><?= $settings['name'] ?></a> | Powered by <a href="https://shoppy.gg/product/099OPQ9" target="_blank">Vie Faucet Script</a></p>
                    </div>
                </div>
