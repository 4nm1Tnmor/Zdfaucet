    ...
    <div class="col-md-6 col-xl-3 mb-3 mb-xl-3">
        <div class="card mini-stats-wid">
            <div class="card-body">
                <div class="media">
                    <div class="media-body">
                        <p class="lh-1 mb-1 font-weight-bold"><?= $settings['reward'] ?> <sup><span class="text-success me-2">+<?= $bonus ?>% bonus</span></sup></p>
                        <p class="mb-0">USD</p>
                    </div>
    ...
    <div class="col-12 col-md-8 col-lg-6 order-md-2 mb-4 text-center">
        ...
        <?php if (!$limit && !$wait) { ?>
            <form action="<?= site_url('/faucet/verify') ?>" method="POST">
                ...
                <button type="submit" class="btn btn-primary btn-lg claim-button" disabled><i class="far fa-check-circle"></i> Collect your reward</button>
                <div class="atb">
                    <?php
                    if ($anti_pos[0] == 5) {
                        echo '<div class="antibotlinks"></div>';
