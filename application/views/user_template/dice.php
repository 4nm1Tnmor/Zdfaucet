                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-2 mr-sm-3">
                                    ...
                                    <input type="number" class="form-control" id="betAmount" value="<?= $settings['min_bet'] ?>" min="<?= $settings['min_bet'] ?>" max="<?= $settings['max_bet'] ?>" step="0.000001" placeholder="Bet Amount">
                    ...
                    <table class="table table-striped text-center">
                        ...
                        <tbody id="diceHistory">
                            ...
                            foreach ($history as $dice) {
                                ...
                                echo '<tr><th scope="row">' . $dice["id"] . '</th><td>' . $dice["salt"] . '</td><td>' . $target . '</td><td>' . $dice['bet'] . '</td><td>' . $dice['roll'] . '</td><td>' . $dice['profit'] . '</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
