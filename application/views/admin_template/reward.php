            ...
            <div class="card-body">
                ...
                <form action="<?= site_url('admin/reward/add') ?>" method="POST">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="number" min="0.000001" step="0.000001" class="form-control" name="depBalanceAmount" placeholder="Amount will be added to user deposit balance" required>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label class="col-sm-3 col-form-label">Add To Energy</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="energyAmount" placeholder="Amount will be added to user energy" required>
                        </div>
                    </div>
