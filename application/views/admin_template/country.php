<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4 text-center">Filter users by country</h4>
                <form action="<?= site_url('admin/country') ?>" method="GET" autocomplete="off">
                    <div class="form-group row mb-4">
                        <label class="col-sm-3 col-form-label text-center">Select country</label>
                        <div class="col-sm-9">
                            <select class="form-control" name="iso">
