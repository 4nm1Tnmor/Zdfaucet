<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Pollfish settings</h4>
                <?php
                if (isset($_SESSION['message'])) {
                    echo $_SESSION['message'];
                }
                ...
                <form action="<?= site_url('admin/update/offerwalls') ?>" method="POST">
                    <div class="form-group row mb-4">
                        <label class="col-sm-3 col-form-label">Pollfish status</label>
                        <div class="col-sm-9">
                            <select class="form-control" name="pollfish_status">
                                <option value="on" <?= ($settings['pollfish_status'] == 'on') ? 'selected' : '' ?>>On</option>
                                <option value="off" <?= ($settings['pollfish_status'] == 'off') ? 'selected' : '' ?>>Off</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="pollfish_api" class="col-sm-3 col-form-label">Pollfish API Key</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="pollfish_api" name="pollfish_api" value="<?= $settings['pollfish_api'] ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="pollfish_secret" class="col-sm-3 col-form-label">Pollfish Secret Key</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="pollfish_secret" name="pollfish_secret" value="<?= $settings['pollfish_secret'] ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="pollfish_hold" class="col-sm-3 col-form-label">Pollfish Hold</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="pollfish_hold" name="pollfish_hold" value="<?= $settings['pollfish_hold'] ?>">
                        </div>
                    </div>
                    <input type="hidden" name="<?= $csrf_name ?>" value="<?= $csrf_hash ?>">
