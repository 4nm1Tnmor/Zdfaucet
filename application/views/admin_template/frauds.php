                        ...
                        <tbody>
                            ...
                            foreach ($users as $fraudContent => $users) {
                                foreach ($users as $ind => $user) {
                                    ...
                                    if ($ind == 0) {
                                        echo '<tr>
                                        <th class="align-middle" rowspan="' . count($users) . '" scope="row">' . $fraudContent . '</th>
                                        ...
                                        <td><a target="_blank" href="' . site_url('admin/users/find?ip=' . $user['ip_address']) . '">' . $user['ip_address'] . ' <i class="fas fa-search"></i></a></td>
                                        <td>' . $country . '</td>
