            ...
            <div class="card-body text-center">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered text-center" style="font-size: 15px;">
                        <thead>
                            <tr>
                                <th scope="col">Logs (Click to see relate cheat logs)</th>
                                <th scope="col">IP Address</th>
                                <th scope="col">Time</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($logs as $log) { ?>
                                <tr>
                                    <th scope="row"><a href="<?= site_url('admin/users/logs/' . $log['id']) ?>" target="_blank"><?= $log['log'] ?></a></th>
                                    <th><a target="_blank" href="<?= site_url('admin/users/find?ip=' . $log['ip_address']) ?>"><?= $log['ip_address'] ?> <i class="fas fa-search"></i></a></th>
