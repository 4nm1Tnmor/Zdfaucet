...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2021 at 11:35 AM
...
(117, 'smtp_username', ''),
(118, 'smtp_password', ''),
(119, 'activity_contest_reward', ''),
(120, 'referral_contest_reward', ''),
(121, 'faucet_contest_reward', ''),
(122, 'shortlink_contest_reward', ''),
(123, 'offerwall_contest_reward', ''),
(124, 'firewall', 'off'),
(125, 'banned_mails', ''),
(126, 'global_notification', ''),
(127, 'captcha_fail_limit', '8'),
...
--
ALTER TABLE `settings`
  MODIFY `id` int(32) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;
